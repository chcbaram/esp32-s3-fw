...
static const gpio_tbl_t gpio_tbl[GPIO_MAX_CH] =
    {
      {GPIO_NUM_2,  _DEF_OUTPUT, _DEF_HIGH, "LCD_CS" }, // 0. LCD CS      
      {GPIO_NUM_3,  _DEF_OUTPUT, _DEF_LOW , "LCD_DC" }, // 1. LCD DC
      {GPIO_NUM_1 , _DEF_OUTPUT, _DEF_LOW , "LCD_BLK"}, // 2. LCD BLK      
      {GPIO_NUM_4 , _DEF_OUTPUT, _DEF_LOW , "LCD_RST"}, // 3. LCD RST
    };
